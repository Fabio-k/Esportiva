-- Inserindo endereços
INSERT INTO address (id, cep, residency_type, street_type, number, neighborhood, city, state, country, observation) VALUES
(1, '01001-000', 'APARTMENT', 'AVENUE', '123', 'Centro', 'São Paulo', 'SP', 'Brasil', 'Próximo ao metrô'),
(2, '22041-001', 'HOUSE', 'STREET', '456', 'Copacabana', 'Rio de Janeiro', 'RJ', 'Brasil', 'Perto da praia'),
(3, '30130-000', 'APARTMENT', 'SQUARE', '789', 'Savassi', 'Belo Horizonte', 'MG', 'Brasil', 'Ao lado do shopping');
