...
CREATE TABLE administrador ( adm_id SERIAL PRIMARY KEY,
                                                   adm_nome VARCHAR(30) NOT NULL,
                                                                        adm_email VARCHAR(30) NOT NULL);


CREATE TABLE cartoes_de_credito ( car_id SERIAL PRIMARY KEY,
...
CREATE TABLE categorias_end ( cae_id SERIAL PRIMARY KEY,
                                                    cae_nome VARCHAR(20) NOT NULL);


CREATE TABLE categorias_produto ( cat_id SERIAL PRIMARY KEY,
                                                        cat_nome VARCHAR(20) NOT NULL);


CREATE TABLE cep ( cep_id SERIAL PRIMARY KEY,
...
CREATE TABLE clientes ( cli_id SERIAL PRIMARY KEY,
...
CREATE TABLE cupons_promocao ( cpr_id SERIAL PRIMARY KEY,
                                                     cpr_desconto_porcentagem FLOAT NOT NULL,
                                                                                    cpr_cli_id INTEGER NOT NULL);


CREATE TABLE cupons_troca ( ctr_id SERIAL PRIMARY KEY,
                                                  ctr_valor FLOAT NOT NULL,
                                                                  ctr_quantidade INTEGER NOT NULL,
                                                                                         ctr_cli_id INTEGER NOT NULL);


CREATE TABLE enderecos ( end_id SERIAL PRIMARY KEY,
...
CREATE TABLE funcao ( fun_end_id INTEGER NOT NULL,
...
CREATE TABLE grupo_precificacao ( grp_id SERIAL PRIMARY KEY,
...
CREATE TABLE pedidos ( ped_id SERIAL PRIMARY KEY,
...
CREATE TABLE pertence ( per_pro_id INTEGER NOT NULL,
...
ALTER TABLE cartoes_de_credito ADD CONSTRAINT cartoes_de_credito_clientes_fk
FOREIGN KEY (car_cli_id) REFERENCES clientes (cli_id);


ALTER TABLE cupons_promocao ADD CONSTRAINT cupons_promocao_clientes_fk
FOREIGN KEY (cpr_cli_id) REFERENCES clientes (cli_id);


ALTER TABLE cupons_troca ADD CONSTRAINT cupons_troca_clientes_fk
FOREIGN KEY (ctr_cli_id) REFERENCES clientes (cli_id);


ALTER TABLE enderecos ADD CONSTRAINT enderecos_cep_fk
FOREIGN KEY (end_cep_id) REFERENCES cep (cep_id);


ALTER TABLE enderecos ADD CONSTRAINT enderecos_clientes_fk
FOREIGN KEY (end_cli_id) REFERENCES clientes (cli_id);


ALTER TABLE funcao ADD CONSTRAINT funcao_categorias_end_fk
FOREIGN KEY (fun_cae_id) REFERENCES categorias_end (cae_id);


ALTER TABLE funcao ADD CONSTRAINT funcao_enderecos_fk
FOREIGN KEY (fun_end_id) REFERENCES enderecos (end_id);


ALTER TABLE pedidos ADD CONSTRAINT pedidos_produtos_fk
FOREIGN KEY (ped_pro_id) REFERENCES produtos (pro_id);


ALTER TABLE pedidos ADD CONSTRAINT pedidos_transacoes_fk
FOREIGN KEY (ped_tra_id) REFERENCES transacoes (tra_id);


ALTER TABLE pertence ADD CONSTRAINT pertence_categorias_produto_fk
FOREIGN KEY (per_cat_id) REFERENCES categorias_produto (cat_id);


ALTER TABLE pertence ADD CONSTRAINT pertence_produtos_fk
FOREIGN KEY (per_pro_id) REFERENCES produtos (pro_id);


ALTER TABLE produtos ADD CONSTRAINT produtos_grupo_precificacao_fk
FOREIGN KEY (pro_grp_id) REFERENCES grupo_precificacao (grp_id);


ALTER TABLE transacoes ADD CONSTRAINT transacoes_clientes_fk
FOREIGN KEY (tra_cli_id) REFERENCES clientes (cli_id);
