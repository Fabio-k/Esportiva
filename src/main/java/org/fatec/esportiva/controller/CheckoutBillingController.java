...
public class CheckoutBillingController {
    ...
    public String saveSplitCard(@ModelAttribute("checkoutSession") CheckoutSession checkoutSession, @ModelAttribute SplitCreditCardForm splitCreditCardForm, @AuthenticationPrincipal Client client){
